...
void AgameAPKPawn::FireShot(FVector FireDirection)
{
	...
	if (bCanFire == true)
	{
		...
		if (FireDirection.SizeSquared() > 0.0f)
		{
			...
			if (World != nullptr)
			{
				...
				World->SpawnActor<AgameAPKProjectile>(SpawnLocation, FireRotation);
			}

			bCanFire = false;
			World->GetTimerManager().SetTimer(TimerHandle_ShotTimerExpired, this, &AgameAPKPawn::ShotTimerExpired, FireRate);
